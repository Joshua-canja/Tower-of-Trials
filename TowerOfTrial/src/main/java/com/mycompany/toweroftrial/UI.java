...
public class UI {
    ...
    public static void tutorialStart() {
        System.out.println("The Tutorial will Starts in 1 minute please prepare yourself Hero\n");
        System.out.println("The Tutorial begins please defeat the Goblin\n");
    }
    public static void printTutorialClear() {
        System.out.println("Congratulations for defeating the Goblin… You have Passed the Tutorial…. You will be move to the Safe zone.. Good luck Climbing the Tower….\n");
    }
